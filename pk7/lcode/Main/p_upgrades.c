...
// {{"Name-------", "BIP---------", Cost----}, pclass_name,      UC_Cat-, Pr, Score, [Group], [Requirements]},
   ...
   {{"SoulCleaver", "SoulCleaver",  10      }, pclass_cybermage, UC_Body, 10,  0.00},
   ...
   {{"Mateba_A",    "MatebaUpgr1",  10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Pistol},
   {{"SPAS_A",      "SPASUpgr1",    10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Shotgun},
   {{"SPAS_B",      "SPASUpgr2",    10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Shotgun},
   {{"SMG_A",       "SMGUpgr1",     10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Rifle},
   {{"SMG_B",       "SMGUpgr2",     10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Rifle},
   {{"SMG_C",       "SMGUpgr3",     10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Rifle},
   {{"IonRifle_A",  "IonRifUpgr1",  10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Launcher},
   {{"IonRifle_B",  "IonRifUpgr2",  10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Launcher},
   {{"CPlasma_A",   "CPlasmaUpgr1", 10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Plasma},
   {{"ShipGun_A",   "ShipGunUpgr1", 10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_BFG},
   {{"ShipGun_B",   "ShipGunUpgr2", 10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_BFG},
