...
// {{"Name-------", "BIP---------", Cost----}, pclass_name,      UC_Cat-, Pr, Score, [Group], [Requirements]},
   ...
   {{"Mateba_A",    "MatebaUpgr",   10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Pistol},
   {{"SPAS_A",      "SPASUpgr",     10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Shotgun},
   {{"SPAS_B",      "SPASUpg2",     10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Shotgun},
   {{"SMG_A",       "SMGUpgr",      10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Rifle},
   {{"SMG_B",       "SMGUpg2",      10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Rifle},
   {{"SMG_C",       "SMGUpg3",      10      }, pclass_cybermage, UC_Weap,  0,  0.00, UG_Rifle},
