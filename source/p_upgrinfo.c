...
struct upgradeinfo const upgrinfobase[UPGR_BASE_MAX] = {
   {{"HeadsUpDisM", "HeadsUpDisp", 0}, pM, UC_Body, 1, UG_HUD, 0, -0.05, UPGR_HeadsUpDisM},
   {{"HeadsUpDisC", "HeadsUpDisp", 0}, pC, UC_Body, 1, UG_HUD, 0, -0.05, UPGR_HeadsUpDisC},
   {{"HeadsUpDisI", "HeadsUpDisp", 0}, pI, UC_Body, 1, UG_HUD, 0, -0.05, UPGR_HeadsUpDisI},
   {{"HeadsUpDisD", "HeadsUpDisp", 0}, pD, UC_Body, 1, UG_HUD, 0, -0.05, UPGR_HeadsUpDisD},
   {{"Zoom", 0, 0}, gA, UC_Body, 0, 0, 0, 0, UPGR_Zoom},
   {{"VitalScan", "VitalScanner", 0}, gA, UC_Body, 2, 0, 0, 0, UPGR_VitalScan},
   {{"ReflexWetw", "ReflexWetw", 0}, gO, UC_Body, 5, 0, 0, -0.05, UPGR_ReflexWetw},
   {{"JetBooster", "JetBooster", 0}, pM, UC_Body, 0, 0, 0, -0.05, UPGR_JetBooster},
   ...
   {{"AutoPistol", 0, 140940}, pM, UC_Weap, 0, 0, 0, 0, UPGR_AutoPistol},
   {{"PlasPistol", 0, 340000}, pM, UC_Weap, 0, 0, UR_WMD, 0, UPGR_PlasPistol},
   ...
   {{"TorgueMode", 0, 8000000}, gA, UC_Extr, 8, 0, UR_RDI, 0, UPGR_TorgueMode},
   {{"7777777", 0, 8235430}, gA, UC_Extr, 7, 0, UR_RDI, 0.10, UPGR_7777777},
   {{"lolsords", 0, 1000000}, gA, UC_Extr, 0, 0, UR_RDI, 0.20, UPGR_lolsords},
   {{"Goldeneye", 0, 70000}, gA, UC_Extr, 0, 0, UR_RDI, 0.07, UPGR_Goldeneye},
   {{"DarkCannon", 0, 1500000}, pM, UC_Extr, 0, UG_BFG, UR_WMD | UR_WRD | UR_RDI, 0, UPGR_DarkCannon},
   {{"Implying", 0, 0}, gA, UC_Down, 0, 0, 0, 0.20, UPGR_Implying},
   {{"UNCEUNCE", 0, 0}, gA, UC_Down, 0, 0, 0, 0.30, UPGR_UNCEUNCE},
   {{"InstaDeath", 0, 0}, gA, UC_Down, 0, 0, 0, 0.50, UPGR_InstaDeath},
