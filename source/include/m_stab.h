...
stab_x(so_c_card_b,      "ChexBlueCard")
stab_x(so_c_card_r,      "ChexRedCard")
stab_x(so_c_card_y,      "ChexYellowCard")
stab_x(so_d_card_b,      "BlueCard")
stab_x(so_d_card_r,      "RedCard")
stab_x(so_d_card_y,      "YellowCard")
stab_x(so_d_skul_b,      "BlueSkull")
stab_x(so_d_skul_r,      "RedSkull")
stab_x(so_d_skul_y,      "YellowSkull")
stab_x(so_htic_k_b,      "KeyBlue")
stab_x(so_htic_k_g,      "KeyGreen")
stab_x(so_htic_k_y,      "KeyYellow")
...
stab_x(sp_HUD_Battery,          ":HUD:Battery")
stab_x(sp_HUD_BatteryOutline,   ":HUD:BatteryOutline")
