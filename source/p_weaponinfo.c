...
struct weaponinfo const weaponinfo[weapon_max] = {
   ...
   {2, pcl_informant, N("Flintlock"),Placeholder2,AT_AMag,A("Shell")},
   {0, pcl_any, N("WingsOfDeath"),Placeholder1,AT_None},
...
i32 P_Wep_FromName(struct player *p, i32 name) {
   ...
   case pcl_informant:
      ...
      case wepnam_fist: return weapon_fist;
      case wepnam_chainsaw: return weapon_fist;
      case wepnam_pistol: return weapon_i_flintlock;
      case wepnam_shotgun: return weapon_fist;
      case wepnam_supershotgun: return weapon_fist;
      case wepnam_chaingun: return weapon_fist;
      case wepnam_rocketlauncher: return weapon_fist;
