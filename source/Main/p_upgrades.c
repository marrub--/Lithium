...
// {{"Name-------", "BIP---------", Cost---}, pcl_name,      UC_Cat-, Pr, Score, [Group], [Requirements]},
   ...
   {{"ReflexWetw",  "ReflexWetw",   0      }, pcl_outcasts,  UC_Body,  5, -0.05},
   ...
   {{"SPAS_A",      "SPASUpgr",     1140400}, pcl_cybermage, UC_Weap,  0,  0.00, UG_Shotgun},
   {{"SPAS_B",      "SPASUpg2",     1111100}, pcl_cybermage, UC_Weap,  0,  0.00, UG_Shotgun},
   ...
   {{"IonRifle_A",  "IonRifleUpgr", 1777000}, pcl_cybermage, UC_Weap,  0,  0.00},
   {{"IonRifle_B",  "IonRifleUpg2", 2655050}, pcl_cybermage, UC_Weap,  0,  0.00},
   {{"CPlasma_A",   "CPlasmaUpgr",  1930500}, pcl_cybermage, UC_Weap,  0,  0.00, UG_Plasma},
   {{"ShipGun_A",   "ShipGunUpgr",  6688800}, pcl_cybermage, UC_Weap,  0,  0.00, UG_BFG},
   {{"ShipGun_B",   "ShipGunUpg2",  6967700}, pcl_cybermage, UC_Weap,  0,  0.00, UG_BFG},
