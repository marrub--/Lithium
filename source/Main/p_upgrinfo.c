...
upgradeinfo_t const upgrinfobase[UPGR_BASE_MAX] = {
   ...
   {{"Zoom", nil, 0}, gA, UC_Body, 0, 0, 0, 0, UPGR_Zoom},
   ...
   {{"AutoPistol", nil, 140940}, pM, UC_Weap, 0, 0, 0, 0, UPGR_AutoPistol},
   {{"PlasPistol", nil, 340000}, pM, UC_Weap, 0, 0, UR_WMD, 0, UPGR_PlasPistol},
   ...
   {{"TorgueMode", nil, 8000000}, gA, UC_Extr, 8, 0, UR_RDI, 0, UPGR_TorgueMode},
   {{"7777777", nil, 8235430}, gA, UC_Extr, 7, 0, UR_RDI, .10, UPGR_7777777},
   {{"lolsords", nil, 1000000}, gA, UC_Extr, 0, 0, UR_RDI, .20, UPGR_lolsords},
   {{"Goldeneye", nil, 70000}, gA, UC_Extr, 0, 0, UR_RDI, .07, UPGR_Goldeneye},
   {{"DarkCannon", nil, 0x7FFFFFFF}, pM, UC_Extr, 0, UG_BFG, UR_WMD|UR_WRD|UR_RDI, 0, UPGR_DarkCannon},
   {{"Implying", nil, 0}, gA, UC_Down, 0, 0, 0, .20, UPGR_Implying},
   {{"UNCEUNCE", nil, 0}, gA, UC_Down, 0, 0, 0, .30, UPGR_UNCEUNCE},
   {{"InstaDeath", nil, 0}, gA, UC_Down, 0, 0, 0, .50, UPGR_InstaDeath},
};
