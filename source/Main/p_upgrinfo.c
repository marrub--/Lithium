...
struct upgradeinfo const upgrinfobase[UPGR_BASE_MAX] = {
   ...
   {{"7777777", 0, 8235430}, gA, UC_Extr, 7, 0, UR_RDI, .10, UPGR_7777777},
   {{"lolsords", 0, 1000000}, gA, UC_Extr, 0, 0, UR_RDI, .20, UPGR_lolsords},
   {{"Goldeneye", 0, 70000}, gA, UC_Extr, 0, 0, UR_RDI, .07, UPGR_Goldeneye},
   {{"DarkCannon", 0, 1500000}, pM, UC_Extr, 0, UG_BFG, UR_WMD|UR_WRD|UR_RDI, 0, UPGR_DarkCannon},
   {{"Implying", 0, 0}, gA, UC_Down, 0, 0, 0, .20, UPGR_Implying},
   {{"UNCEUNCE", 0, 0}, gA, UC_Down, 0, 0, 0, .30, UPGR_UNCEUNCE},
   {{"InstaDeath", 0, 0}, gA, UC_Down, 0, 0, 0, .50, UPGR_InstaDeath},
};
