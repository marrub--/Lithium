...
stab_x(sf_lareanam, "lareanam")
stab_x(sf_litalics, "litalics")
stab_x(sf_ljsmlfnt, "ljsmlfnt")
stab_x(sf_ljtrmfnt, "ljtrmfnt")
...
stab_x(sc_sv_notitleintro, CVAR "sv_notitleintro")
...
stab_x(sm_CheckReplacementHeuristics, "CheckReplacementHeuristics")
...
stab_x(sm_GetAirControl, "GetAirControl")
...
stab_x(so_Kenshirou, OBJ "Kenshirou")
...
stab_x(so_ShieldBlast, OBJ "ShieldBlast")
...
stab_x(sp_HUD_D_ScopeOverlay, ":HUD_D:ScopeOverlay")
stab_x(sp_HUD_D_ScopeOverlay2, ":HUD_D:ScopeOverlay2")
stab_x(sp_HUD_D_ScopeOverlay3, ":HUD_D:ScopeOverlay3")
...
stab_lang_x(sl_cbi_dimdriver, LANG "CBI_DimDriver")
...
stab_ary_bgn_x(sa_psave)
stab_ary_ent_x(CVAR "psave_0")
stab_ary_ent_x(CVAR "psave_1")
stab_ary_ent_x(CVAR "psave_2")
stab_ary_ent_x(CVAR "psave_3")
stab_ary_ent_x(CVAR "psave_4")
stab_ary_ent_x(CVAR "psave_5")
stab_ary_ent_x(CVAR "psave_6")
stab_ary_ent_x(CVAR "psave_7")
stab_ary_ent_x(CVAR "psave_8")
stab_ary_ent_x(CVAR "psave_9")
stab_ary_ent_x(CVAR "psave_10")
stab_ary_ent_x(CVAR "psave_11")
stab_ary_ent_x(CVAR "psave_12")
stab_ary_ent_x(CVAR "psave_13")
stab_ary_ent_x(CVAR "psave_14")
stab_ary_ent_x(CVAR "psave_15")
stab_ary_end_x()
